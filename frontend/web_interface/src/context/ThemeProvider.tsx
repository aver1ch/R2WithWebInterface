...
export const ThemeProvider = ({
  ...
  useEffect(() => {
    ...
    if (activeTheme === "dark") {
      ...
      root.style.setProperty(
        "--button-shadow",
        "0px 11px 6px 0px rgba(189, 50, 50, 0.2)"
      );
      root.style.setProperty(
        "--button-shadow-hover",
        "0px 1px 6px 0px rgba(189, 50, 50, 0.8)"
      );
      root.style.setProperty("--button-border", "1px solid #BD3232");
    } else {
      root.style.setProperty("--bg-primary", "#ffffff");
      root.style.setProperty("--bg-secondary", "rgba(255, 255, 255, 0.9)");
      root.style.setProperty("--bg-card", "rgba(240, 240, 240, 0.95)");
      ...
      root.style.setProperty(
        "--button-shadow-hover",
        "0px 5px 6px 0px rgba(0, 0, 0, 0.6)"
      );
